...
public abstract class CustomBaseAdapter<E> extends BaseAdapter implements List<E> {
    ...
    public CustomBaseAdapter(int capacity) {
        list = new ArrayList<E>(capacity);
    }

    public CustomBaseAdapter(Collection<? extends E> collection) {
